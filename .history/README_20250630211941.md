...
We provide quick training and inference scripts for ``clip pipeline`` of visual reconstruction. In this task, we use original clip embedding to train EEG encoder. Please modify your data set path and run zero-shot on 200 classes test dataset:
```
