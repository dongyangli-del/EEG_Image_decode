...
class Proj_eeg(nn.Sequential):
    def __init__(self, embedding_dim=40, proj_dim=1024, drop_proj=0.5):
        super().__init__(
...
def main():
    config = {
        ...
        "logger": True,
        "insubject": True,
        "encoder_type": 'ATM_S_reconstruction_scale_0_100',
