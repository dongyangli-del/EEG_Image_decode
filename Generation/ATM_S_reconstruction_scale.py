...
def main():
    ...
    "logger": True,
    "insubject": True,
    "encoder_type": 'ATM_S_reconstruction_scale',
    ...
    for sub in subjects:                    
        ...
        results_file = f'./outputs/{config["encoder_type"]}_{"in" if config["insubject"] else "cross_exclude_"}{sub}.csv'
