...
def main():
    ...
    "logger": True,
    "insubject":True,
    "encoder_type":'ATM_S_reconstruction_scale_400_500',
    ...
    if config['insubject']:
        for sub in subjects:                    
            ...
            text_features_train_all.to(device)
            text_features_test_all.to(device)
            img_features_train_all.to(device)
