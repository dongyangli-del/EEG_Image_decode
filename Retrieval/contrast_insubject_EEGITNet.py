...
def main_train_loop(model, train_dataloader, test_dataloader, optimizer, device, 
    ...
    for epoch in range(config['epochs']):
        ...
        train_loss, train_accuracy, features_tensor = train_model(model, train_dataloader, optimizer, device, text_features_train_all, img_features_train_all)
        # if epoch%5 == 0:            
