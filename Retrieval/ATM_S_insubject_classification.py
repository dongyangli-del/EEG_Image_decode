...
def main_train_loop(sub, current_time, eeg_model, img_model, train_dataloader, test_dataloader, optimizer, device, 
    ...
    for epoch in range(config['epochs']):
        ...
        print(f"Epoch {epoch + 1}/{config['epochs']} - v2 Accuracy:{v2_acc} - v4 Accuracy:{v4_acc} - v10 Accuracy:{v10_acc} - v50 Accuracy:{v50_acc} - v50_top5_acc: {v50_top5_acc:.4f} - v100 Accuracy:{v100_acc} - v100_top5_acc{v100_top5_acc}")
